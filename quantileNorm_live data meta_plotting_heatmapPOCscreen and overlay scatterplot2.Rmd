...
write.table(file = paste(save.path, "stats.out.data.df_3sdSUM_quantile.txt", sep =""), stats.out.data.df, sep ="\t", row.names = FALSE)
...
pdf(paste(save.path, "timecourses_1sided_sd3SUM_quantile.pdf", sep =""), height = 14, width = 22)
