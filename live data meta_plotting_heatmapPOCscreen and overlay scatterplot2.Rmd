...
=======
>>>>>>> 8012e3a67319ab67bb29288a9e132664b1ff1669
...
=======
                                mean(meanSummaryStat, na.rm= TRUE)
                               ,
                               by = c("plateID", "variable", "timeAfterExposure")]
setnames(DMSO.mean, old = "V1", new = "DMSO.mean")
setkeyv(DMSO.mean, c("plateID", "variable", "timeAfterExposure"))
setkeyv(my.data.response, c("plateID", "variable", "timeAfterExposure"))
...
p 
=======
  geom_line(aes(group = replID )) + theme_sharp()
...
=======
dir.create("model fit graphs")
pdf(file = paste("model fit graphs/model fit graphs.pdf", sep =""), height = 6, width = 6)
for( i in seq_along(my.data.response.list)){
  
  fm1 <- lm(minmaxNorm ~ bs(timeAfterExposure, df =6), data = my.data.response.list[[i]])
  model.results[[i]] <-  predict(fm1, dtTime<-data.frame(
    
    timeAfterExposure = round(seq(0, 20, length.out=200), digits=2))) # variabele tijd.
>>>>>>> 8012e3a67319ab67bb29288a9e132664b1ff1669
...
=======
     dir.create("model fit graphs means")
pdf(file = paste("model fit graphs means/model fit graphs means.pdf", sep =""), height = 6, width = 6) 
      for(i in seq_along(model.results.l.m)){
       p <- ggplot(data =  model.results.l.m[[i]], aes(x=timeAfterExposure, y = meanR)) + geom_point() + 
          geom_point(data= my.data.response.list[[i]], aes(x=timeAfterExposure, y = minmaxNorm, color = replID)) + 
    ggtitle(unique(my.data.response.list[[i]]$splitL)) + ylim(c(0,1))
...
=======
my.array<- array(unlist(dist.treat.dose), c(28,28,11))
>>>>>>> 8012e3a67319ab67bb29288a9e132664b1ff1669
...
=======
11*28*28-length(unlist(dist.treat.dose))  
>>>>>>> 8012e3a67319ab67bb29288a9e132664b1ff1669
